...
public class OgrenciIsleri {
	...
	/* OgrenciIsleri adinda bir class olusturun 
	 * Ogrenci kayit, ogrenci goruntuleme,
	 * ogrenci silme ve cikis methodlari 
	 * olusturun bu methodlari switch case ile cagirin
	 */
	...
	public static void ogrenciKayit() {
		...
		System.out.println("Lutfen sirasiyla ogrenci numarasini, adini soyadini ve ortalamsini giriniz");
	...
	public static void ogrenciSilme() {
		...
		System.out.println("Ogrenci silinmistir. Listemizin yeni hali " + ogrenciler);
